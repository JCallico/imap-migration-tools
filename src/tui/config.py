...
FIELDS: tuple[ConfigField, ...] = (
    ...
    ConfigField("IMAP_HOST", "Count host", "imap-count aliases", advanced=True),
    ConfigField("IMAP_USERNAME", "Count username", "imap-count aliases", advanced=True),
    ConfigField("IMAP_PASSWORD", "Count password", "imap-count aliases", "secret", advanced=True),
    ConfigField("OAUTH2_CLIENT_ID", "Count OAuth2 client ID", "imap-count aliases", advanced=True),
    ConfigField("OAUTH2_CLIENT_SECRET", "Count OAuth2 client secret", "imap-count aliases", "secret", advanced=True),
    ConfigField(
        "ACCOUNT_TYPE",
        "Count account type",
        "imap-count aliases",
    ...
    ConfigField("OAUTH2_CACHE_ENABLED", "Persistent cache", "imap-count aliases", "boolean", "true"),
    ConfigField("OAUTH2_CACHE_DIR", "Cache directory", "imap-count aliases", "path"),
    ConfigField(
        "SRC_ACCOUNT_TYPE",
        "Source account type",
